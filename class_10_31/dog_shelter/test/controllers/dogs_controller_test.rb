...
class DogsControllerTest < ActionController::TestCase
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post :create, dog: { age_week: @dog.age_week, age_year: @dog.age_year, breed: @dog.breed, color: @dog.color, name: @dog.name, size_in: @dog.size_in }
    end
  ...
  test "should update dog" do
    patch :update, id: @dog, dog: { age_week: @dog.age_week, age_year: @dog.age_year, breed: @dog.breed, color: @dog.color, name: @dog.name, size_in: @dog.size_in }
    assert_redirected_to dog_path(assigns(:dog))
  end
